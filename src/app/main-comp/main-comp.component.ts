...
import { OdometerComponent } from '../shared/odometer/odometer.component'; // adjust path if needed
...
@Component({
  ...
  standalone: true,
  imports: [PdfComponenComponent, FormsModule, CommonModule,OdometerComponent],
